...
5. Почему вы хотите участвовать в стажировке?
    ...
    Я хотелбы учавствовать в стажировке, поскольку это возможность для меня расширить свои навыки и знания в области ИБ, которая меня всегда интересовала. На практических занятиях было много заданий, однако ни одно из
